...
ECHO .output %resultDir%\\mlac_tbl_access_flags.sql >> ExSQLite.sql
ECHO .schema mlac_tbl_access_flags >> ExSQLite.sql
ECHO .output %resultDir%\\mlac_tbl_object_types.sql >> ExSQLite.sql
ECHO .schema mlac_tbl_object_types >> ExSQLite.sql
ECHO .output %resultDir%\\mlac_tbl_modules.sql >> ExSQLite.sql
ECHO .schema mlac_tbl_modules >> ExSQLite.sql
ECHO .output %resultDir%\\mlac_tbl_roles.sql >> ExSQLite.sql
ECHO .schema mlac_tbl_roles >> ExSQLite.sql
ECHO .output %resultDir%\\mlac_tbl_user_role.sql >> ExSQLite.sql
ECHO .schema mlac_tbl_user_role >> ExSQLite.sql
ECHO .output %resultDir%\\mlac_tbl_role_permission.sql >> ExSQLite.sql
ECHO .schema mlac_tbl_role_permission >> ExSQLite.sql
